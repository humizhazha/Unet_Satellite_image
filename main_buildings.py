...
flags.DEFINE_string("checkpoint_dir", "checkpoint/buildings/current", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("best_checkpoint_dir", "checkpoint/buildings/best", "Directory name to save the best checkpoints [checkpoint]")
flags.DEFINE_string("results_dir", "results/buildings/", "Directory name to save the results [results]")
