...
flags.DEFINE_integer("type_number", 7, "No. of class type")

flags.DEFINE_string("data_directory", "../data", "Directory name containing the dataset")
flags.DEFINE_string("checkpoint_dir", "checkpoint/slow_water/current", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("best_checkpoint_dir", "checkpoint/slow_water/best", "Directory name to save the best checkpoints [checkpoint]")
flags.DEFINE_string("results_dir", "results/slow_water/", "Directory name to save the results [results]")
