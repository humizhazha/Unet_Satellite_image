...
flags.DEFINE_string("checkpoint_dir", "checkpoint/roads/current", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("best_checkpoint_dir", "checkpoint/roads/best", "Directory name to save the best checkpoints [checkpoint]")
flags.DEFINE_string("results_dir", "results/roads/", "Directory name to save the results [results]")
