...
# Define flags
flags = tf.app.flags
flags.DEFINE_integer("epoch", 1, "Number of training epochs (default: 300)")
...
flags.DEFINE_integer("type_number", 4, "No. of class type")

flags.DEFINE_string("data_directory", "../data", "Directory name containing the dataset")
flags.DEFINE_string("checkpoint_dir", "checkpoint/trees/current", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("best_checkpoint_dir", "checkpoint/trees/best", "Directory name to save the best checkpoints [checkpoint]")
