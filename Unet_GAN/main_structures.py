...
flags.DEFINE_integer("type_number", 1, "No. of class type")

flags.DEFINE_string("data_directory", "../data", "Directory name containing the dataset")
flags.DEFINE_string("checkpoint_dir", "checkpoint/structures/current", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("best_checkpoint_dir", "checkpoint/structures/best", "Directory name to save the best checkpoints [checkpoint]")
flags.DEFINE_string("results_dir", "results/structures/", "Directory name to save the results [results]")
